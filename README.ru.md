...
- Сводка по текущему поиску: кнопка Σ показывает итоги, долю ошибок, число ответов от моков, объём, медиану / 95-й перцентиль / максимум задержки, коды, методы и самые активные хосты; клик по хосту оставляет в поиске только его.
